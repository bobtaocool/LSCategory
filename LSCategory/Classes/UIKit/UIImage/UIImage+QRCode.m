...
+ (UIImage *)ls_barCodeImageWithInfo:(NSString *)info
{
    ...
    UIImage *image =[self ls_createNonInterpolatedUIImageFormCIImage:outputImage withSize:300];
    return image;
}

+ (UIImage *)ls_qrCodeImageWithInfo:(NSString *)info centerImage:(UIImage *)centerImage  width:(CGFloat)width
{
    if (!info) {
        return nil;
    }
    ...
    UIImage *codeImage = [UIImage ls_createNonInterpolatedUIImageFormCIImage:qrImage withSize:width];
    //二维码rect
